...
const dashboardViews = new Set(['overview', 'robots', 'operations', 'autoxing', 'cenobots', 'workforce', 'reports', 'support', 'admin']);
const roleViews = {
  robot_user:['overview','robots','operations','reports','support'],
  auditor:['overview','robots','operations','reports','admin'],
  owner:['overview','robots','operations','reports','support'],
  technician:['overview','robots','operations','workforce','reports','support'],
...
(async function init() { applyLanguage(); bindUi(); if (!await restoreSession()) showLogin(); })();
